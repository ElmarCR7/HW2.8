...
const aza = JSON.parse(localStorage.getItem('aza')) || []
...
function AddNewObg() {
    ...
    const taza = [...aza, newObg]
    aza.unshift(newObg)
    localStorage.setItem('data', JSON.stringify(aza))
    RenderItems(aza)
    Close()
}
...
function Search() {
    ...
    const newArray = aza.filter((element) =>
...
function RenderItems(aza) {
    container.innerHTML = ''; 
    aza.forEach((element, index) => {
